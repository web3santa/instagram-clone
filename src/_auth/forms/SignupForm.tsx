...
const SignupForm = () => {
  ...
  const { mutateAsync: createUsrAccount, isPending: isCreatingAccount } = userCreateUserAccount()
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex flex-col">
        ...
        <p className="text-light-3 font-medium">To use Snapgram Please enter your details</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
          ...
          <p className="text-sm text-light-2 text-center mt-2">
            ...
            <Link to={"/sign-in"} className="text-primary-500 text-sm ml-1">Log in</Link>
          </p>
        </form>
      </div>
